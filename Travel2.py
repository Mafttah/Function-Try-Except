def Travel():
    ...
    if place == "1":
        ...
        print("You have selected Triumph Arc.")
        ...
        print("You have selected Stefan Cel Mare Central Park.")
        print("This park is named after Stephen the Great, a Moldavian ruler known for his military victories and for defending the region against foreign invaders.")
    elif place == "4":
        print("You have selected Stefan cel Mare si Sfant Boulevard.")
        print("This boulevard is named after Stephen the Great, a significant historical figure in Moldovan history.")
    elif place == "5":
        print("You have selected Valea Morilor Park.")
        print("Valea Morilor Park is a popular recreational area in Chisinau, known for its beautiful lake and walking paths.")
    elif place == "6":
        print("You have selected Mustafa Kemal Atatürk Library.")
        print("This library is named after the founder of modern Turkey and is an important cultural institution in Chisinau.")
    elif place == "7":
        print("You have selected Strada Lenin Street.")
        ...
        print("You have selected Central Park.")
    ...
    if place == "1":
        print("You have selected Noul Neamt Monastry.")
        ...
        print("You have selected 25th October Street.")
    ...
    if place == "1":
        ...
        print("You have selected St Constantin and Helena Cathedral.")
        ...
        print("You have selected St. Nicolae Cathedral Balti.")
    ...
    print("1. -> Soroca Fortress")
    place = input("Where do you want to start? -> 1(1):\n ").strip()
    if place == "1":
        print("You have selected Soroca Fortress.")
        ...
        print(f"2. Ukraine", "3. Russia", "4. Estonia   ", "5. Lithuania", "6. Belarus", "7. Poland", "8. Latvia")
